...
public:
	...
	bool Blit(SDL_Texture* texture, int x, int y, SDL_Rect* section = NULL, float speed = 1.0f, double angle = 0, bool flipX = false, bool flipY = false, int pivot_x = INT_MAX, int pivot_y = INT_MAX);
